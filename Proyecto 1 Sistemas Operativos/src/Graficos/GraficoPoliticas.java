...
public class GraficoPoliticas extends JPanel {
    ...
    public GraficoPoliticas() {
        politicas = Arrays.asList("FCFS", "HRRN", "MLFQ", "SPN", "SRT", "RR");
        valores = new Long[]{0L, 0L, 0L, 0L, 0L, 0L};

        chart = new CategoryChartBuilder()
                .width(800)
                .height(500)
                .title("Uso de Politicas")
                .xAxisTitle("Politica")
                .yAxisTitle("Ciclos")
        ...
        chart.addSeries("Procesos", politicas, Arrays.asList(valores));
    ...
    public void actualizar(Long[] nuevosValores) {
        this.valores = nuevosValores;
        chart.updateCategorySeries("Procesos", politicas, Arrays.asList(valores), null);
        chartPanel.repaint();
    }
}
